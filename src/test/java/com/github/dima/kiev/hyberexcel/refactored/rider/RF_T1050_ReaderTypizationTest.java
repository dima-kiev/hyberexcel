...
@DisplayName("RF1050. Read Field type actions")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class RF_T1050_ReaderTypizationTest {
    ...
    static void setup() throws IOException {
        RReader<S2TypesEntity> reader = new RReader<S2TypesEntity>(new Workbook(INPUT_FILE_PATH)){};
        records = reader.lineObjects();
    }
